  ...
  return (
    <div className="space-y-8 p-4 md:p-6">
      ...
      <div className="grid gap-6 md:grid-cols-2 xl:grid-cols-3">
        ...
        >
          <div className="mb-5 flex h-12 w-12 items-center justify-center rounded-2xl text-2xl shadow-sm" style={{ background: `${WITS_BLUE}12`, color: WITS_BLUE }}>
            ✦
          </div>
          <p className="text-xs font-semibold uppercase tracking-[0.22em]" style={{ color: WITS_GOLD }}>
            Create
          </p>
          <h2 className="mt-3 font-serif text-2xl text-[#043673]">Create Quest</h2>
          <p className="mt-3 text-sm leading-6 text-slate-600">
            Build a new challenge, assign a location, define the question, and publish it to the map once its card is complete.
          </p>
          <div className="mt-5 inline-flex items-center rounded-xl px-4 py-2 text-sm font-semibold text-white" style={{ background: WITS_BLUE }}>
            Open events
          </div>
        </Link>
        ...
        <Link
          ...
          className="group rounded-[28px] border border-[#043673]/10 bg-white p-6 shadow-[0_2px_24px_-10px_rgba(4,54,115,0.2)] transition hover:-translate-y-1 hover:shadow-[0_12px_30px_-12px_rgba(4,54,115,0.3)]"
        >
          <div className="mb-5 flex h-12 w-12 items-center justify-center rounded-2xl text-2xl shadow-sm" style={{ background: `${WITS_GOLD}22`, color: WITS_BLUE }}>
            ▣
          </div>
          <p className="text-xs font-semibold uppercase tracking-[0.22em]" style={{ color: WITS_GOLD }}>
            Card studio
          </p>
          <h2 className="mt-3 font-serif text-2xl text-[#043673]">Cards</h2>
          <p className="mt-3 text-sm leading-6 text-slate-600">
            Define the rarity and strength of each event card, from easy blue cards to gold hard challenge drops.
          </p>
          <div className="mt-5 inline-flex items-center rounded-xl px-4 py-2 text-sm font-semibold text-white" style={{ background: WITS_GOLD }}>
            Manage cards
          </div>
        </Link>
      </div>
      ...
      <section className="grid gap-6 lg:grid-cols-2">
        <div className="rounded-[28px] border border-slate-200 bg-white p-5 shadow-[0_2px_24px_-10px_rgba(4,54,115,0.2)]">
          ...
          {pendingChallenges.length === 0 ? (
            <p className="text-sm text-slate-500">No pending events right now.</p>
          ) : (
